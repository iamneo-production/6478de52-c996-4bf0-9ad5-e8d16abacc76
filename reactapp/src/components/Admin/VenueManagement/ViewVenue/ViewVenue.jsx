    ...
    return (
        <div>
            ...
            <div className='ViewVenue-SearchWrapper'>
                <TextField type="text" className='Search-Input' id="venueName" label="Search" value={venue.venueName}
            ...
            {(venues.length !== 0) ?
                (
                    <Grid className="d-flex justify-content-center" container spacing={1}> {
                        (reset) ? (venue.venuedataarr.map((cards, index) => {
                            return (
                                <Grid item style={{ padding: "20px" }} key={index} id={"adminVenueGrid" + (index + 1)}>
                                    <Card style={{ width: 350, borderRadius: "10px", border: "none" }} hoverable="true">
                                        <CardActionArea style={{ height: 350 }}>
                                            <CardMedia
                                                component="img"
                                                style={{ width: 350, height: 250, borderRadius: "10px 10px 0px 0px", objectFit: "fill" }}
                    ...
                    </Grid>) : (<div className="d-flex justify-content-center"><CircularProgress /></div>)}
